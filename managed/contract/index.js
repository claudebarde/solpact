...
const _descriptor_7 = new __compactRuntime.CompactTypeVector(3, _descriptor_4);
...
export class Contract {
    ...
    this.circuits = {
      post: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(newMessage_0),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(1n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue({ is_some: false, value: '' }),
                                    ...
                                    __compactRuntime.convertFieldToBytes(32,
                                                                         _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                   ...
                                                                                                                                   [
                                                                                                                                    ...
                                                                                                                                    { popeq: { cached: true,
                                                                                                                                               result: undefined } }]).value),
                                                                         'bboard.compact line 27 char 51'));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _takeDown_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            1,
                            'Attempted to take down a vacant board');
                                                            ...
                                                            __compactRuntime.convertFieldToBytes(32,
                                                                                                 _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                                                           ...
                                                                                                                                                           [
                                                                                                                                                            ...
                                                                                                                                                            { popeq: { cached: true,
                                                                                                                                                                       result: undefined } }]).value),
                                                                                                 'bboard.compact line 34 char 59'))),
                            'Only the original poster can take down the message');
    const formerMsg_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                  partialProofData,
                                                                                  [
                                                                                   { dup: { n: 0 } },
                                                                                   { idx: { cached: false,
